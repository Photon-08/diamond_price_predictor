...
def train():
    ...
    df = pd.read_csv("https://drive.google.com/file/d/16XcJAgr-ChvIm9A4h2oxppglkPu74-8v/view?usp=share_link", header=["carat",'cut','color','clarity','depth','table','price','x','y','z'])
